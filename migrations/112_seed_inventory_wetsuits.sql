...
--    - thickness：純數字部分，單位用小寫 mm（1mm / 2/2mm / 3mm / 3/2mm / 5/4mm …）
...
BEGIN
  ...
  INSERT INTO product_variants (product_id, vendor_code, attributes, price, stock) VALUES
    (pid, 'BI2MWNP01', '{"thickness":"3/2mm","coverage":"全身","size":"LG","color":"黑"}'::jsonb, 10500, 1);

  -- Barrel / Brlsu0479（1 SKU）
  INSERT INTO products (category, brand, model) VALUES ('wetsuit', 'Barrel', 'Brlsu0479') RETURNING id INTO pid;
  INSERT INTO product_variants (product_id, vendor_code, attributes, price, stock) VALUES
    (pid, 'XXs19_wfs_03', '{"thickness":"5/4mm","coverage":"全身","size":"XS","color":"黑水藍"}'::jsonb, 7650, 1);
  ...
  INSERT INTO product_variants (product_id, vendor_code, attributes, price, stock) VALUES
    (pid, 'ERJW803029', '{"thickness":"1mm","coverage":"半身","size":"4","color":"黑"}'::jsonb, 4580, 1);
  ...
  INSERT INTO product_variants (product_id, vendor_code, attributes, price, stock) VALUES
    (pid, 'PRBSU0001', '{"thickness":"3mm","coverage":"全身","size":"S","color":"黑"}'::jsonb, 11800, 2);
  ...
  INSERT INTO product_variants (product_id, vendor_code, attributes, price, stock) VALUES
    (pid, 'F97005', '{"gender":"M","thickness":"1mm","coverage":"半身","size":"M","color":"黑"}'::jsonb, NULL, 3),
    (pid, 'F97005', '{"gender":"M","thickness":"1mm","coverage":"半身","size":"L","color":"黑"}'::jsonb, NULL, 1);
  ...
  INSERT INTO product_variants (product_id, vendor_code, attributes, price, stock) VALUES
    (pid, 'F10701', '{"gender":"M","thickness":"3/2mm","coverage":"全身","size":"L","color":"黑"}'::jsonb, NULL, 1);
  ...
  INSERT INTO product_variants (product_id, vendor_code, attributes, price, stock) VALUES
    (pid, 'F12723', '{"thickness":"2/2mm","coverage":"半身","size":"M","color":"黑"}'::jsonb, 8000, 1);
