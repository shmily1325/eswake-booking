  ...
  FOR v_model, v_sizes IN
    ...
    FROM (
      VALUES
        ...
        ('DRAKE'::TEXT,         '["3''11","4''0","4''1","4''2","4''3","4''4","4''5","4''6","4''7","4''8","4''9","4''10"]'::JSONB),
        ('ENIGMA'::TEXT,        '["3''11","4''0","4''1","4''2","4''3","4''4","4''5","4''6","4''7","4''8","4''9","4''10"]'::JSONB)
    ) models(model, sizes)
  LOOP
    SELECT p.id
    INTO v_product_id
  ...
  FOR v_dimension IN
    ...
    FROM (
      VALUES
        ...
        ('DRAKE', '3''11', 18.74, 1.53, 14.7),
        ('DRAKE', '4''0', 18.87, 1.54, 15.2),
        ('DRAKE', '4''1', 19.00, 1.55, 15.7),
        ('DRAKE', '4''2', 19.13, 1.56, 16.2),
        ('DRAKE', '4''3', 19.25, 1.57, 16.8),
        ('DRAKE', '4''4', 19.37, 1.58, 17.4),
        ('DRAKE', '4''5', 19.50, 1.59, 18.1),
        ('DRAKE', '4''6', 19.63, 1.60, 18.5),
        ('DRAKE', '4''7', 19.75, 1.62, 19.0),
        ('DRAKE', '4''8', 19.87, 1.63, 20.0),
        ('DRAKE', '4''9', 20.00, 1.64, 21.5),
        ('DRAKE', '4''10', 20.13, 1.65, 22.5),
        ('ENIGMA', '3''11', 18.85, 1.50, 13.73),
        ('ENIGMA', '4''0', 18.98, 1.55, 14.63),
        ('ENIGMA', '4''1', 19.10, 1.60, 15.53),
        ('ENIGMA', '4''2', 19.23, 1.65, 16.49),
        ('ENIGMA', '4''3', 19.35, 1.70, 17.47),
        ('ENIGMA', '4''4', 19.48, 1.75, 18.48),
        ('ENIGMA', '4''5', 19.60, 1.80, 19.53),
        ('ENIGMA', '4''6', 19.73, 1.85, 20.61),
        ('ENIGMA', '4''7', 19.85, 1.90, 21.73),
        ('ENIGMA', '4''8', 19.98, 1.95, 22.89),
        ('ENIGMA', '4''9', 20.10, 2.00, 24.05),
        ('ENIGMA', '4''10', 20.23, 2.05, 25.28)
