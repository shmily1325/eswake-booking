-- =============================================
-- 127_settle_shop_order_per_line_tx.sql
-- 扣儲值結帳：每品項一筆 transaction + 可自訂 description
-- p_items 新增可選 description；items_snapshot 一併保存
-- =============================================
...
SELECT '127_settle_shop_order_per_line_tx: per-line balance transactions' AS status;
