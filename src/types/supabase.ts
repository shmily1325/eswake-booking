  ...
  public: {
    Tables: {
      ...
      billing_relations: {
        ...
        Relationships: [
          {
            foreignKeyName: "billing_relations_billing_member_id_fkey"
      ...
      boat_part_movements: {
        ...
        Relationships: [
          {
            foreignKeyName: "boat_part_movements_part_id_fkey"
            columns: ["part_id"]
            isOneToOne: false
            referencedRelation: "boat_parts"
            referencedColumns: ["id"]
          },
        ]
      }
      boat_parts: {
        Row: {
          ...
          notes: string | null
          part_no: string | null
          pending_repair_quantity: number
    ...
    Functions: {
      ...
      apply_boat_part_movement: {
        Args: {
          p_boat_code?: string | null
          p_moved_at?: string | null
