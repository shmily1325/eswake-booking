      ...
      >
        <div
          style={{
            ...
            justifyContent: 'space-between',
            alignItems: 'baseline',
            padding: isMobile ? `${designSystem.spacing.sm} ${designSystem.spacing.xs}` : 0,
        ...
        {!loading && !loadError && filteredParts.length === 0 && (
          <p
            style={{
          ...
          filteredParts.map(part => (
            <button
              ...
              style={{
                width: '100%',
                display: 'grid',
                gridTemplateColumns: isMobile ? '1fr auto' : 'minmax(130px, 0.7fr) 1.5fr 1fr 110px 100px',
                gap: isMobile ? designSystem.spacing.sm : designSystem.spacing.lg,
                alignItems: 'center',
                padding: isMobile
                  ? `${designSystem.spacing.lg} ${designSystem.spacing.xs}`
                  : `${designSystem.spacing.lg} ${designSystem.spacing.sm}`,
                border: 'none',
            ...
            >
              ...
              {!isMobile && (
                <>
                  <div>{part.category || '未分類'}</div>
                  <div style={{ color: designSystem.colors.text.secondary }}>
                    {part.storage_location || '未填儲位'}
                  </div>
                </>
              )}
              ...
              {!isMobile && <span style={stockStateStyle(part)}>{stockStateLabel(part)}</span>}
            </button>
          ))}
      </section>
