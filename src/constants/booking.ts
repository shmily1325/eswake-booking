...
/** 船空檔搜尋：列出的課程開始時間約在此區間內（與使用者「到」取交集後仍須放得下整段課） */
export const AVAILABILITY_SEARCH_CLIP_START_MINUTES = 6 * 60
/** 最晚可列出的課程開始時間（分鐘），含此分鐘起點 */
export const AVAILABILITY_SEARCH_CLIP_LAST_START_MINUTES = 17 * 60